...
curs.execute("select customers.custnm, products.prodnm, products.company, products.price from customers inner join products on customers.prodid= products.prodid")
